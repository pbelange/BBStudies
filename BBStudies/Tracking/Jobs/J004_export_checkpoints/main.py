...
def tracking_to_HTML(data_path,checkpoint_path,partition_name,partition_ID):
    ...
    grid1 = bklay.gridplot([[BOKEH_FIGS['x-px'] ,BOKEH_FIGS['y-py'] ,BOKEH_FIGS['zeta-pzeta']]],toolbar_location='right')
    #=====================================
    ...
    grid2 = bklay.gridplot([[BOKEH_FIGS['JxJy']]],toolbar_location='right')
    #=====================================
    ...
    #=====================================
    tab_margin = 20
    bottom_tabs = bkmod.Tabs(tabs=[ bkmod.TabPanel(child=grid1, title="Phase Space"), 
                                    bkmod.TabPanel(child=grid2, title="Action"),
